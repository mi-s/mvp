...
public class DialogScript : MonoBehaviour
{
    ...
    void Start()
    {
        dialogMaze = new string[] {"Welcome to the Maze Game Tutorial!",
        ...
        dialogMachine = new string[] {"Welcome to the Machine Game Tutorial!",
    ...
    public void ContinueDialogMaze()
    {
        if (dialogIndex < 5)
        {
            dialogIndex++;
            tutorialText.text = dialogMaze[dialogIndex];
        }
    }

    public void ContinueDialogMachine()
    {
        if (dialogIndex < 5)
        {
            dialogIndex++;
            tutorialText.text = dialogMachine[dialogIndex];
        }
    }
}
